...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Noms correctes i descriptius segons la NOVA distribució de pàgines
        ...
        # ================================================================= #
        #  INJECCIÓ DELS GRÀFICS SEGONS LA NOVA DISTRIBUCIÓ DE FRAMES       #
        # ================================================================= #
        # --- PÀGINA 1 ---
        ...
        self.inject_canvas(self.ui.horaFrame, self.canvas_dialab)  # Modificat de frame_9 a horaFrame
        ...
        # Dibuixar els gràfics fixos històrics de fons
        self.inicializar_graficos_fijos()

        # Nota: pushButton i pushButton_2 ja es connecten automàticament des del setupUi del teu nou .ui
    ...
    def inicializar_graficos_fijos(self):
        ...
        # --- Gràfic Històric Global (Ara a la Pàgina 3) ---
        ...
        # --- Gràfic Històric de Vies (Ara a la Pàgina 1) ---
    ...
    def limpiar_filtros(self):
        ...
        # Forçar l'actualització manual amb dades nets globals
